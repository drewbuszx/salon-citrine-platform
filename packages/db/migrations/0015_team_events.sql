...
insert into public.team_events (
  ...
  (
    ...
    'event',
    ((current_date + interval '7 days')::timestamp + time '09:00') at time zone 'America/Indiana/Indianapolis',
    ((current_date + interval '7 days')::timestamp + time '10:00') at time zone 'America/Indiana/Indianapolis',
    false,
  ...
  (
    ...
    'closure',
    (current_date + interval '14 days')::timestamp at time zone 'America/Indiana/Indianapolis',
    ((current_date + interval '14 days')::timestamp + time '23:59') at time zone 'America/Indiana/Indianapolis',
    true,
    'a1000001-0001-4000-8000-000000000001',
    null
  ),
  (
    ...
    'time_off',
    (current_date + interval '3 days')::timestamp at time zone 'America/Indiana/Indianapolis',
    ((current_date + interval '5 days')::timestamp + time '23:59') at time zone 'America/Indiana/Indianapolis',
    true,
  ...
  (
    ...
    'announcement',
    (current_date + interval '2 days')::timestamp at time zone 'America/Indiana/Indianapolis',
    null,
    true,
